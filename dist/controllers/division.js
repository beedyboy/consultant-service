...
var _division = _interopRequireDefault(require("../services/division"));
...
var DivisionController = /*#__PURE__*/(0, _createClass2["default"])(function DivisionController() {
  var _this = this;

  (0, _classCallCheck2["default"])(this, DivisionController);
  (0, _defineProperty2["default"])(this, "service", new _division["default"]());
      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this.service.getByCategory(req.params.id);
  ...
  (0, _defineProperty2["default"])(this, "update", /*#__PURE__*/function () {
    var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res, next) {
      var _req$body, id, division, category, result;
      ...
      return _regenerator["default"].wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _req$body = req.body, id = _req$body.id, division = _req$body.division, category = _req$body.category;
              _context5.next = 4;
              return _this.service.update(id, {
                division: division,
                category: category
              });
...
var _default = DivisionController;
